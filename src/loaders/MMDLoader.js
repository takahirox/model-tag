...
MMDLoader.prototype.createModel = function ( buffer, modelExtension, texturePath ) {
...
MMDLoader.VectorKeyframeTrackEx.prototype = Object.create( THREE.VectorKeyframeTrack.prototype );
...
MMDLoader.QuaternionKeyframeTrackEx.prototype = Object.create( THREE.QuaternionKeyframeTrack.prototype );
...
MMDLoader.NumberKeyframeTrackEx.prototype = Object.create( THREE.NumberKeyframeTrack.prototype );
...
var MMDHelper = function ( renderer ) {
...
MMDHelper.prototype = {
	...
	add: function ( mesh ) {
		...
		if ( ! ( mesh instanceof THREE.SkinnedMesh ) ) {
			...
			throw new Error( 'MMDHelper.add() accepts only THREE.SkinnedMesh instance.' );
